      ...
      <div className="max-w-3xl mx-auto space-y-6 animate-fade-in">
            ...
            <div className="flex items-start gap-3">
              ...
              <div className="space-y-2">
                <p className="text-sm font-medium text-amber-800 dark:text-amber-200">
                  Coffre-fort — Mode consultation uniquement
                </p>
                <p className="text-sm text-amber-700 dark:text-amber-300">
                  Le coffre-fort a été remplacé par le nouveau centre documentaire, plus structuré et sécurisé.
                  Vos documents existants restent accessibles ici en lecture seule. Pour ajouter de nouveaux documents, utilisez le centre documentaire.
                </p>
                <Button size="sm" variant="outline" className="gap-2 mt-1" onClick={() => navigate('/documents')}>
                  <ArrowRight className="h-4 w-4" />
                  Accéder au centre documentaire
                </Button>
              </div>
            </div>
          </CardContent>
        ...
        <div>
          <h1 className="font-heading text-2xl font-semibold text-foreground flex items-center gap-2">
            ...
            Coffre-fort
            <Badge variant="outline" className="text-xs ml-2">Archives</Badge>
          </h1>
          <p className="text-sm text-muted-foreground mt-1">
            Documents déposés avant la transition. Consultation uniquement.
          </p>
        </div>
        ...
        {documents.length === 0 ? (
          <Card className="shadow-soft">
            <CardContent className="py-12 text-center">
              ...
              <p className="text-muted-foreground">Aucun document dans l'ancien coffre-fort.</p>
            </CardContent>
          </Card>
        ) : (
