...
export const sendInvitationEmail = async ({
  ...
  // Site URL (lovable.dev), which causes "Access denied" for invitees.
  // Instead, the invitee lands on /invitation/accept?token=... in our app
  // and signs in/up normally — the token is auto-consumed on login.
